...
//fonction pour tester et completer les differentes heures de livraison
...
int main()
{
    ...
    int i;
    cout<<"======================================================================"<<endl;
    cout<<"BONJOUR, CE PROGRAMME PERMET DE GERER LES CHAUFFEURS ET LES LIVRAISONS"<<endl;
    cout<<"======================================================================"<<endl;
    cout<<"Pour commencer, tapez le chiffre 1 si vous etes gestionnaire "<<endl;
    cout<<" tapez le chiffre 2 si vous etes chauffeur "<<endl;
    cout<<"======================================================================"<<endl;
    cin>>i;
    switch(i){
    case gestionnaire:
        cout<<"Indication Importante: 15.30 corresponds a 15h30"<<endl;
        cout<<""<<endl;
        ...
        cout<<endl;
        cout<<endl;
        cout<<"Donner le nombre de commandes du Chauffeur 1 pour les Funerailles"<<endl;
        ...
        cout<<"pour chauffeur 1,donner le nombre des commandes Simple :"<<endl;
        ...
        cout<<"pour le chauffeur 2,donner le nombre des commandes funeraire"<<endl;
        ...
        cout<<"pour le chauffeur 2,donner le nombre des commandes pour Entreprise"<<endl;
        ...
        cout<<"pour le chauffeur5,donner le nombre des commandes funeraire :"<<endl;
    ...
    case chauffeur:
        ...
        cout<<"le chauffeur 3 a :"<<chauffeur3.fun.getNbreFuneraire()<<" Commande funeraire, "<<endl;
         afficherlesHeures(60,60+chauffeur3.fun.getNbreFuneraire(),lesHeures,"funeraire");
         cout<<endl;
        cout<<chauffeur3.ent.getNbreEntreprise()<<"Commande pour entreprise, "<<endl;
        afficherlesHeures(70,70+chauffeur3.ent.getNbreEntreprise(),lesHeures,"Entreprise");
        ...
        cout<<endl;cout<<endl;
         ...
         cout<<"le chauffeur 4 a :"<<chauffeur4.fun.getNbreFuneraire()<<" Commande funeraire "<<endl;
         afficherlesHeures(90,90+chauffeur4.fun.getNbreFuneraire(),lesHeures,"Funeraire");
         cout<<endl;
        cout<<chauffeur4.ent.getNbreEntreprise()<<" Commande pour entreprise,"<<endl;
        afficherlesHeures(100,100+chauffeur4.ent.getNbreEntreprise(),lesHeures,"entreprises");
        ...
        cout<<endl;cout<<endl;
         ...
         cout<<"le chauffeur 5 a : "<<chauffeur5.fun.getNbreFuneraire()<<" Commande funeraire, "<<endl;
         afficherlesHeures(120,120+chauffeur5.fun.getNbreFuneraire(),lesHeures,"Funeraire");
         cout<<endl;
        cout<<chauffeur5.ent.getNbreEntreprise()<<"Commande pour entreprise, "<<endl;
        afficherlesHeures(130,130+chauffeur5.ent.getNbreEntreprise(),lesHeures,"Entreprise");
